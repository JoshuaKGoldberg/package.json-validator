...
extend( QUnit, {
	...
	objectType: function( obj ) {
		...
		const type = toString.call( obj ).match(/^\[object\s(.*)\]$/)[1] || "";
...
QUnit.load = function() {
	...
	let banner, filter, i, label, len, main, ol, toolbar, userAgent, val, urlConfigCheckboxes, moduleFilter,
	    numModules = 0,
	    moduleFilterHtml = "",
		urlConfigHtml = "",
